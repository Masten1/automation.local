...
class VehicleModule extends fvModule{
    ...
    function showGetVehicle(){
        $data = $this->getRequest()->getRequestParameter("data");
        $id = $this->getRequest()->getRequestParameter("id");
        $tiers = $this->getRequest()->getRequestParameter("tier");


        $object = Emp_Vehicle::getManager()->getByPk($id);
        $object->hydrate($data);
        ...
        return $this->__display("getvehicle.tpl");
    }
