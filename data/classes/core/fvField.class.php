...
abstract class fvField {
    ...
    /** Поле редактируемое у констрейнта */
    protected $ceditable = true;
    ...
    function updateSchema( array $fieldSchema ) {
        ...
        if ( isset( $fieldSchema[ 'ceditable' ] ) )
            $this->ceditable = ( bool ) $fieldSchema[ 'ceditable' ];
    }
